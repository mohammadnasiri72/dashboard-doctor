import { Checkbox, IconButton, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Tooltip } from '@mui/material'
...
export default function TableDiagnosis({medicalRecord , setIsLoading , setFlag}) {
  ...
  const deleteDiagnosisHandler = (e)=>{
    Swal.fire({
      title: 'حذف تشخیص',
        ...
        <Table sx={{ minWidth: 650 }} aria-label="sticky table">
          <TableHead className="">
            <TableRow>
              ...
              <TableCell align="center">نام تشخیص</TableCell>
              <TableCell align="center">توضیحات</TableCell>
              <TableCell align="center">عملیات</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {medicalRecord.map((e, i) => (
              <TableRow key={i}>
                <TableCell>
                ...
                <TableCell align="center">
                    <div className="flex justify-center">
                      <Tooltip title="حذف" placement="left">
                        <IconButton
                         onClick={() => deleteDiagnosisHandler(e)}
                         >
