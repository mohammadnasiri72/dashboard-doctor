...
export default function ModalEditCat({ setIsLoading, setFlag2, handleCloseMenu , valTypeCategoryList , typeCategoryList}) {
    ...
    <>
      <React.Fragment>
        ...
        <Dialog sx={{ zIndex: '9999' }} fullWidth={true} maxWidth="sm" open={open} onClose={handleClose}>
          ...
          <DialogActions>
            <Button
            onClick={() => editCatHandler(valTypeCategoryList)}
            >
              ویرایش
            </Button>
          </DialogActions>
