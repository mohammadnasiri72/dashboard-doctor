...
export default function MobileLogin({abroad , setAbroad , setIsLoading}) {
  ...
  return (
    <>
      ...
      {isValiedMobile && (
        <MobileLoginPageTwo setIsValiedMobile={setIsValiedMobile} mobileNumber={mobileNumber} setMobileNumber={setMobileNumber} setIsLoading={setIsLoading}/>
      )}
    </>
  );
}
